...
export const DEMO_FAMILIES = [
  { name: '田中 里奈', phone: '090-1234-5678', pets: [
    { name: 'マロン', breed: 'トイプードル', birthday: '2021-02-14', notes: '♀。テディベアカット・耳周り短めのご希望。ペットスクール 月4回。かかりつけ: 北区どうぶつ病院' },
    { name: 'ムギ', breed: '柴', birthday: '2024-05-03', notes: '♂。マロンと同時来店が多い。回数券利用' },
  ]},
  { name: '山口 健太', phone: '080-2345-6789', pets: [
    { name: 'ソラ', breed: '柴', birthday: '2025-06-20', notes: '♂。ペットスクール 月8回。トイレトレーニング中。かかりつけ: 梅田ペットクリニック' },
  ]},
  ...
  { name: '中島 翔太', phone: '070-4567-8901', pets: [
    { name: 'レオ', breed: 'ポメラニアン', birthday: '2024-03-18', notes: '♂。ペットスクール 月4回。ボール遊びが得意。かかりつけ: 天満どうぶつ病院' },
  ]},
  ...
  { name: '西村 大輔', phone: '070-0123-4567', pets: [
    { name: 'ベル', breed: 'M.シュナウザー', birthday: '2021-07-07', notes: '♀。ペットスクール 月8回。お迎えが18時以降になることが多い。かかりつけ: 扇町アニマルクリニック' },
  ]},
];
